...
SECRET_KEY = '0!u%0huabi#ubqo0ob-fdn_e4pv=^y970w)p5vsq4fafs&$=jc'
...
# Application definition
    #added localflavor for US ZIP Code parsing,bootsrap
    #local flavor can be added through pip install django-localflavor
INSTALLED_APPS = [
